                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nama" placeholder="Nama" required class="form-control @error('nama') is-invalid @enderror">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="telepon" placeholder="Telepon" required class="form-control @error('telepon') is-invalid @enderror">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="provinsi" class="form-control select2">
                                            ...
                                            @foreach ($provinsi as $data)
                                                <option value="{{ $data->provinsi }}">{{ ucwords($data->provinsi) }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="alamat" rows="5" class="form-control @error('alamat') is-invalid @enderror"></textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="kodepos" placeholder="Kode Pos" class="form-control @error('kodepos') is-invalid @enderror">
